...
execute at @a[team=Runners] as @a[team=Hunters,distance=..50] run title @a[team=Runners] actionbar {"text": "There are hunters near you!", "color": "yellow"}
execute at @a[team=Hunters] as @a[team=Runners,distance=..50] run title @a[team=Hunters] actionbar {"text": "You are near one or more runners!", "color": "yellow"}